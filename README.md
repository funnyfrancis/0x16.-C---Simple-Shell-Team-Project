...
```
git clone https://github.com/funnyfrancis/0x16.-C---Simple-Shell-Team-Project.git
cd 0x16.-C---Simple-Shell-Team-Project
gcc *.c -o hsh
```
...
## Authors
* [Onwumbiko Francis](https://github.com/funnyfrancis)
* [Abiy Aman](https://github.com/abiy006)
